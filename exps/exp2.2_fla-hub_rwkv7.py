...
# https://github.com/BlinkDL/RWKV-LM/blob/main/RWKV-v7/rwkv_mmlu_eval.py
...
if not HF_MODE:
    ...
    MODEL_NAME = "/data/_models/Blink_DL/rwkv-7-world/RWKV-x070-World-1.5B-v3-20250127-ctx4096"
